<%@ Page Title="" Language="C#" MasterPageFile="~/IE_Kaizen/OM/IE_Kaizen_OM_Central_Master.Master" AutoEventWireup="true" CodeBehind="ViewEvaluatorEvaluation_Evaluate.aspx.cs" Inherits="Industrial_Engineering.IE_Kaizen.OM.ViewEvaluatorEvaluation_Evaluate" %>
            ...
            <div class="col">
                <div class="mb-3">
                    ...
                    <div>
                        <div>
                            <div class="row mb-3 form-group">
                                <asp:Label ID="txtomCommentsSTATIC" class="col-form-label" runat="server" Text="OM Comments* :"></asp:Label>
                                <div class="col">
                                    <asp:TextBox ID="txtomComments" runat="server" CssClass="form-control" TextMode="MultiLine" />
                                </div>
                                <asp:Label ID="txtomCommentsLabel1s" class="col-form-label" ForeColor="Red" runat="server"></asp:Label>
                            </div>
