<%@ Page Title="" Language="C#" MasterPageFile="~/IE_Kaizen/OM/IE_Kaizen_OM_Central_Master.Master" AutoEventWireup="true" CodeBehind="RejectedKaizens.aspx.cs" Inherits="Industrial_Engineering.IE_Kaizen.OM.RejectedKaizens" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentPlaceHolder1" runat="server">
    ...
    <div class="card shadow">
        <div class="card-header shadow">Rejected Kaizen List</div>
        <div class="card-body shadow">
            <div class="mb-3">
                <div class="row mb-3 form-group">
