<%@ Page Title="" Language="C#" MasterPageFile="~/IE_Kaizen/Coordinator/IE_Kaizen_Coordinator_Central_Master.Master" AutoEventWireup="true" CodeBehind="CO_view_details_of_action.aspx.cs" Inherits="Industrial_Engineering.IE_Kaizen.Coordinator.CO_view_details_of_action" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentPlaceHolder1" runat="server">
    <div class="card shadow">
        <div class="card-header font-weight-bold shadow">View Coordinator Action on Kaizen</div>
            ...
            <div class="col">
                <div class="mb-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <div class="row mb-3 form-group">
                                ...
                                <div class="col">
                                    <asp:DropDownList ID="ddlPlantDepartmentco" runat="server" ReadOnly="true" CssClass="form-control">
                    ...
                    <div class="row">
                        <div class="col-md-5">
                            <div class="row mb-3 form-group">
                                <asp:Label ID="Discipline_labelSTATICco" runat="server" class="col-form-label"  ReadOnly="true"  Text="discipline">Discipline* :</asp:Label>
                                <div class="col">
                                    <asp:DropDownList ID="ddlDisciplineco" runat="server"  ReadOnly="true" CssClass="form-control">
                                        <asp:ListItem>--select one--</asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                            </div>
                        ...
                        <div class="col-md-5">
                            <div class="row mb-3 form-group">
                                ...
                                <div class="col">
                                    <asp:TextBox ID="Txtregistrationdate" runat="server" TextMode="Date"  ReadOnly="true"  CssClass="form-control" />
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-5">
                            <div class="row mb-3 form-group">
                                ...
                                <div class="col">
                                    <asp:TextBox ID="TextEmail" runat="server" CssClass="form-control"  ReadOnly="true" placeholder="abc@rcfltd.com" />
                                </div>
                            </div>
                        ...
                        <div class="col-md-5">
                            <div class="row mb-3 form-group">
                                ...
                                <div class="col">
                                    <asp:DropDownList ID="ddlforwared_reject" runat="server"  ReadOnly="true"  CssClass="form-control">
                                        <asp:ListItem>--select one--</asp:ListItem>
                                    </asp:DropDownList>
                    ...
                    <div class="row">
                        <div class="col-md-5">
                            <div class="row mb-3 form-group">
                                ...
                                <div class="col">
                                    <asp:TextBox ID="TextRemarks" runat="server" CssClass="form-control"  ReadOnly="true" placeholder="Reason of Action by coordinator" />
                                </div>
                            </div>
