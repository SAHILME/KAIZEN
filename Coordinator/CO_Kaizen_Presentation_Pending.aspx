<%@ Page Title="" Language="C#" MasterPageFile="~/IE_Kaizen/Coordinator/IE_Kaizen_Coordinator_Central_Master.Master" AutoEventWireup="true" CodeBehind="CO_Kaizen_Presentation_Pending.aspx.cs" Inherits="Industrial_Engineering.IE_Kaizen.Coordinator.CO_Kaizen_Presentation_Pending" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentPlaceHolder1" runat="server">

    <div class="card shadow">
        <div class="card-header font-weight-bold shadow">View Kaizen List Pending For Presentation</div>
    ...
    <div class="card shadow">
        <div class="card-header shadow">Kaizens List Pending For Presentation</div>
        <div class="card-body shadow">
            <div class="col">
                <div class="mb-3">
                    <div class="row">
                        <div class="col-md-5">
                            <div class="row mb-3 form-group">
                                <asp:Label ID="TxtPresentationdateLabel1Static" runat="server" class="col-form-label" Text="Enter Presentation Date: "></asp:Label>
                                <div class="row">
                                <div class="col">
                                   <asp:TextBox ID="TxtPresentationdate" runat="server" TextMode="Date" CssClass="form-control" />
                                    
                                </div>
                                    &nbsp<asp:Button ID="Fill_Presentation_Date" runat="server" Text="Fill Date" CssClass="btn btn-success" OnClientClick="return confirm('Are you sure you want to proceed?');" OnClick="btnFill_Presentation_Date_Click" />
                                    </div>
                                
                                <asp:Label ID="TxtPresentationdateLabel" runat="server" class="col-form-label" ForeColor="Red" Text=""></asp:Label>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="table-responsive">
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField>
                                    <HeaderTemplate>
                                        <asp:Label ID="chkSelectAll" runat="server" AutoPostBack="True" Text=" Check" />
                                    </HeaderTemplate>
                                    <ItemTemplate>
                                        <asp:CheckBox ID="chkSelect" runat="server" OnCheckedChanged="chkSelect_CheckedChanged" AutoPostBack="False" />
                                    </ItemTemplate>
                                </asp:TemplateField>

                                <asp:TemplateField HeaderText="View Details">
                                    <ItemTemplate>
                                        <asp:Button ID="btnView" runat="server" Text="View Details" CommandName="ViewDetails" BackColor="#4e73df" ForeColor="White" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
