<%@ Page Title="" Language="C#" MasterPageFile="~/IE_Kaizen/Coordinator/IE_Kaizen_Coordinator_Central_Master.Master" AutoEventWireup="true" CodeBehind="ViewActionPage.aspx.cs" Inherits="Industrial_Engineering.IE_Kaizen.Coordinator.View_Action_Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentPlaceHolder1" runat="server">
    <asp:Label ID="pageleveLabel1" runat="server" Text=""></asp:Label>
    <div class="card shadow">
        <div class="card-header font-weight-bold shadow">View and Action on Kaizen</div>
            ...
            <div class="col">
                <div class="mb-3">
                    ...
                    <div class="row">
                        <div class="col-md-5">
                            <div class="row mb-3 form-group">
                                <asp:Label ID="TextkaizenIDSTATIC" class="col-form-label" runat="server" Text="Kaizen ID :"></asp:Label>
                                <div class="col">
                                    <asp:TextBox ID="TextkaizenID" runat="server" CssClass="form-control" placeholder="Kaizen ID" ReadOnly="true" />
                                </div>
                            </div>
                            <asp:Label ID="TextkaizenID_label" class="col-form-label" ForeColor="Red" runat="server"></asp:Label>
                        </div>
                        &nbsp &nbsp &nbsp &nbsp
                        <div class="col-md-5">
                            <div class="row mb-3 form-group">
                                <asp:Label ID="Plant_Department_labelSTATICco" runat="server" class="col-form-label" Text="Plant/Department">Plant/Department* :</asp:Label>
                                <div class="col">
                                    <asp:DropDownList ID="ddlPlantDepartmentco" runat="server" CssClass="form-control"></asp:DropDownList>
                                </div>
                            </div>
                            <asp:Label ID="Plant_Department_labelco" runat="server" ForeColor="Red" class="col-form-label"></asp:Label>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-5">
                            <div class="row mb-3 form-group">
                                <asp:Label ID="Discipline_labelSTATICco" runat="server" class="col-form-label" Text="discipline">Discipline* :</asp:Label>
                                <div class="col">
                                    <asp:DropDownList ID="ddlDisciplineco" runat="server" CssClass="form-control">
                                    </asp:DropDownList>
                                </div>
                            </div>
                            <asp:Label ID="Discipline_labelco" runat="server" ForeColor="Red" class="col-form-label"></asp:Label>
                        </div>
                        &nbsp &nbsp &nbsp &nbsp
                       <div class="col-md-5">
                            <div class="row mb-3 form-group">
                                <asp:Label ID="forwared_reject_labelSTATIC" runat="server" class="col-form-label" Text="Action* :"></asp:Label>
                                <div class="col">
                                    <asp:DropDownList ID="ddlforwared_reject" runat="server" CssClass="form-control" OnSelectedIndexChanged="ddlforwared_reject_SelectedIndexChanged" AutoPostBack="True">
                                    </asp:DropDownList>
                                    <asp:RequiredFieldValidator runat="server" ID="ddlforwared_rejectRequired" ValidationGroup="saveandsubmit" InitialValue="---Select One---" ControlToValidate="ddlforwared_reject" CssClass="alert-danger" ErrorMessage="Please Select One Option!"></asp:RequiredFieldValidator>
                                </div>
                                <asp:Label ID="forwared_reject_label" runat="server" ForeColor="Red" class="col-form-label"></asp:Label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-5">
                            <div class="row mb-3 form-group">
                                <asp:Label ID="TextEmailLabel3STATIC" class="col-form-label" runat="server" Text="Email* :"></asp:Label>
                                <div class="col">
                                    <asp:TextBox ID="TextEmail" runat="server" CssClass="form-control" placeholder="abc@rcfltd.com" />
                                </div>
                            </div>
                            <asp:Label ID="TextEmailLabel4" class="col-form-label" ForeColor="Red" runat="server"></asp:Label>
                        </div>
                        &nbsp &nbsp &nbsp &nbsp
                     <div class="col-md-5">
                            <div class="row mb-3 form-group">
                                <asp:Label ID="TxtregistrationdateLabel1STATIC" runat="server" class="col-form-label" Text="Registration Date* :"></asp:Label>
                                <div class="col">
                                    <asp:TextBox ID="Txtregistrationdate" runat="server" TextMode="Date" CssClass="form-control" />
                                </div>
                            </div>
                            <asp:Label ID="TxtregistrationdateLabel1" runat="server" class="col-form-label" ForeColor="Red" Text=""></asp:Label>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-5">
                            <div class="row mb-3 form-group">
                                <asp:Label ID="TextRemarksLabel1STATIC" class="col-form-label" runat="server" Text="Remarks* :"></asp:Label>
                                <div class="col">
                                    <asp:TextBox ID="TextRemarks" runat="server" CssClass="form-control" placeholder="Reason of Action by coordinator" />
                                </div>
                            </div>
                            <asp:Label ID="TextRemarksLabel2" class="col-form-label" ForeColor="Red" runat="server"></asp:Label>
                        </div>
                         &nbsp &nbsp &nbsp &nbsp
                        <div class="col-md-5">
                            <div class="row mb-3 form-group">
                                <asp:Label ID="TextEvaluatorLabel1STATIC" class="col-form-label" runat="server" Text="Evaluator* :"></asp:Label>
                                <div class="col">
                                    <asp:TextBox ID="TextEvaluator" runat="server" CssClass="form-control" Readonly="True" />
                                </div>
                            </div>
                            <asp:Label ID="TextEvaluatorLabel2" class="col-form-label" ForeColor="Red" runat="server"></asp:Label>
                        </div>
                    </div>
                    <br />
                    <div>
                        <asp:Button ID="btnSubmit" runat="server" Text="Submit" ValidationGroup="saveandsubmit" CssClass="btn btn-success" OnClick="btnSubmit_Click" />
                        <br />
                        <asp:Label ID="btnSubmitlabel" runat="server" class="font-italic" Text=""></asp:Label>
                    </div>
                </div>
            </div>
        </div>
