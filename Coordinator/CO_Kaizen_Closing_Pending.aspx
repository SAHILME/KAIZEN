<%@ Page Title="" Language="C#" MasterPageFile="~/IE_Kaizen/Coordinator/IE_Kaizen_Coordinator_Central_Master.Master" AutoEventWireup="true" CodeBehind="CO_Kaizen_Closing_Pending.aspx.cs" Inherits="Industrial_Engineering.IE_Kaizen.Coordinator.CO_Kaizen_Closing_Pending" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentPlaceHolder1" runat="server">

    <div class="card shadow">
        <div class="card-header font-weight-bold shadow">View Kaizen List Pending For Closing</div>
    ...
    <div class="card shadow">
        <div class="card-header shadow">Kaizens List Pending For Closing</div>
        <div class="card-body shadow">
            <div class="col">
                <div class="mb-3">
                    <div class="row">
                        <div class="col-md-5">
                            <div class="row mb-3 form-group">
                                <asp:Label ID="TxtClosingLabel1Static" runat="server" class="col-form-label" Text="Enter Closing Date: "></asp:Label>
                                <div class="row">
                                <div class="col">
                                   <asp:TextBox ID="TxtClosing" runat="server" TextMode="Date" CssClass="form-control" />
                                    
                                </div>
                                    &nbsp<asp:Button ID="Fill_Closing_Date" runat="server" Text="Fill Date" CssClass="btn btn-success" OnClientClick="return confirm('Are you sure you want to proceed?');" OnClick="btnFill_Closing_Date_Click" />
                                    </div>
                                
                                <asp:Label ID="TxtClosingLabel" runat="server" class="col-form-label" ForeColor="Red" Text=""></asp:Label>
                            </div>
                        </div>
                    </div>
                </div>
