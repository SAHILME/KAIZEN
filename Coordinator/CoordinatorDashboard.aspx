<%@ Page Title="" Language="C#" MasterPageFile="~/IE_Kaizen/Coordinator/IE_Kaizen_Coordinator_Central_Master.Master" AutoEventWireup="true" CodeBehind="CoordinatorDashboard.aspx.cs" Inherits="Industrial_Engineering.IE_Kaizen.Coordinator.CoordinatorDashboard" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentPlaceHolder1" runat="server">
    ...
    <div class="card shadow">
        <div class="card-header shadow">Kaizens List Waiting for Registration</div>
        <div class="card-body shadow">
            <div class="mb-3">
                <div class="row mb-3 form-group">
                        ...
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="View Details">
                                    <ItemTemplate>
                                        <asp:Button ID="btnView" runat="server" Text="View & Action" CommandName="ViewDetails" BackColor="#4e73df" ForeColor="White" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" />
                                    </ItemTemplate>
                                </asp:TemplateField>
