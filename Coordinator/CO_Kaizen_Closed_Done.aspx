<%@ Page Title="" Language="C#" MasterPageFile="~/IE_Kaizen/Coordinator/IE_Kaizen_Coordinator_Central_Master.Master" AutoEventWireup="true" CodeBehind="CO_Kaizen_Closed_Done.aspx.cs" Inherits="Industrial_Engineering.IE_Kaizen.Coordinator.CO_Kaizen_Closed_Done" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentPlaceHolder1" runat="server">

    <div class="card shadow">
        <div class="card-header font-weight-bold shadow">View Closed Kaizen List </div>
    ...
    <div class="card shadow">
        <div class="card-header shadow">Closed Kaizens List </div>
                    ...
                    <div class="table-responsive">
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="ModifiedclosedDate" HeaderText="Closed Date" SortExpression="ModifiedclosedDate" />
