<%@ Page Title="" Language="C#" MasterPageFile="~/IE_Kaizen/Coordinator/IE_Kaizen_Coordinator_Central_Master.Master" AutoEventWireup="true" CodeBehind="CO_Forward_Kaizen_List.aspx.cs" Inherits="Industrial_Engineering.IE_Kaizen.Coordinator.CO_Forward_Kaizen_List" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentPlaceHolder1" runat="server">

    <div class="card shadow">
        <div class="card-header font-weight-bold shadow">View Forwarded Kaizen List</div>
    ...
    <div class="card shadow">
        <div class="card-header shadow">Fowarded Kaizens List Waiting for Evaluation</div>
        <div class="card-body shadow">
            <div class="mb-3">
                <div class="row mb-3 form-group">
