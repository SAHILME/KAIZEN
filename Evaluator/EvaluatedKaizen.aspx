<%@ Page Title="" Language="C#" MasterPageFile="~/IE_Kaizen/Evaluator/IE_Kaizen_Evaluator_Central_Master.Master" AutoEventWireup="true" CodeBehind="EvaluatedKaizen.aspx.cs" Inherits="Industrial_Engineering.IE_Kaizen.Evaluator.EvaluatedKaizen" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentPlaceHolder1" runat="server">
    ...
    <div class="card shadow">
        <div class="card-header shadow">Evaluated Kaizens List</div>
        <div class="card-body shadow">
            <div class="mb-3">
                <div class="row mb-3 form-group">
