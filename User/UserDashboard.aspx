<%@ Page Title="" Language="C#" MasterPageFile="~/IE_Kaizen/User/IE_Kaizen_User_Central_Mater.Master" AutoEventWireup="true" CodeBehind="UserDashboard.aspx.cs" Inherits="Industrial_Engineering.IE_Kaizen.User.UserDashboard" %>
    ...
    <div class="card shadow">
        ...
        <div class="card-body shadow">
                        ...
                        <tbody>
                            ...
                            <tr>
								...
								<tr>
                                    ...
                                    <td>Productivity: &nbsp &nbsp<asp:CheckBox ID="Productivity" runat="server" /> &nbsp &nbsp
                   ...
                   <div class="row mb-3 form-group font-italic">
                    ...
                    <div class=" row">
                        ...
                        <div>
                            ...
                            <asp:Button ID="btnSave" runat="server" Text="Save as Draft" ValidationGroup="saveandsubmit" CssClass="btn btn-primary" OnClick="btnSave_Click"/>
           ...
           <div> 
               ...
               <asp:Button ID="btnSubmit" runat="server" Text="Kaizen Submit" ValidationGroup="saveandsubmit" CssClass="btn btn-success" OnClick="btnSubmit_Click" />
